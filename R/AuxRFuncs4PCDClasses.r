...
###############################################
#'
#' @title Print a \code{Lines} object
#'
#' @description Prints the \code{call} of the object of class '\code{Lines}'
#' and also the \code{coefficients} of the line (in the form: y = slope * x + intercept).
#'
#' @param x A \code{Lines} object.
...
########################
#'
#' @title Return a summary of a \code{Lines} object
#'
...
########################
#'
#' @title Print a summary of a \code{Lines} object
#'
#' @description Prints some information about the \code{object}.
#'
#' @param x	 object of class "\code{summary.Lines}", generated by \code{summary.Lines}.
...
########################
#'
#' @title Plot a \code{Lines} object
#'
...
#'
#' @title Print a \code{TriLines} object
#'
#' @description Prints the \code{call} of the object of class '\code{TriLines}'
#' and also the \code{coefficients} of the line (in the form: y = slope * x + intercept),
#' and the vertices of the triangle with respect to which the line is defined.
#'
#' @param x A \code{TriLines} object.
#' @param \dots Additional arguments for the S3 method '\code{print}'.
#'
#' @return
#' The \code{call} of the object of class '\code{TriLines}' ,
#' the \code{coefficients} of the line (in the form: y = slope * x + intercept),
#' and the vertices of the triangle with respect to which the line is defined.
#'
...
########################
#'
#' @title Return a summary of a \code{TriLines} object
#'
#' @description Returns the below information about the \code{object}:
#'
#' \code{call} of the function defining the \code{object}, the defining \code{points}, selected x and y points on the line,
...
#' and \code{coefficients} of the line (in the form: y = slope * x + intercept).
#'
...
########################
#'
#' @title Print a summary of a \code{TriLines} object
#'
#' @description Prints some information about the \code{object}
#'
#' @param x	 object of class "\code{summary.TriLines}", generated by \code{summary.TriLines}.
#' @param \dots Additional parameters for \code{print}.
#'
#' @return
#' None
...
########################
#'
#' @title Plot a \code{TriLines} object
#'
...
###############################################
#'
#' @title Print a \code{Lines3D} object
#'
#' @description Prints the \code{call} of the object of class '\code{Lines3D}',
#' the \code{coefficients} of the line (in the form: x=x0 + a*t, y=y0 + b*t, and z=z0 + c*t),
#' and the initial point together with the direction vector.
#'
#' @param x A \code{Lines3D} object.
#' @param \dots Additional arguments for the S3 method '\code{print}'.
#'
#' @return
#' The \code{call} of the object of class '\code{Lines3D}',
#' the \code{coefficients} of the linee (in the form: x=x0 + a*t, y=y0 + b*t, and z=z0 + c*t),
#' and the initial point together with the direction vector.
#'
...
########################
#'
#' @title Return a summary of a \code{Lines3D} object
#'
#' @description Returns the below information about the \code{object}:
#'
...
#' selected x, y and z points on the line,
#' equation of the line (in parametric form), and \code{coefficients} of the line
#' (for the form: x=x0 + a*t, y=y0 + b*t, and z=z0 + c*t).
#'
...
########################
#'
#' @title Print a summary of a \code{Lines3D} object
#'
#' @description Prints some information about the \code{object}.
#'
#' @param x	 object of class "\code{summary.Lines3D}", generated by \code{summary.Lines3D}.
#' @param \dots Additional parameters for \code{print}.
#'
#' @return
#' None
...
########################
#'
#' @title Plot a \code{Lines3D} object
#'
...
###############################################
#'
#' @title Print a \code{Planes} object
#'
#' @description Prints the \code{call} of the object of class '\code{Planes}'
#' and also the \code{coefficients} of the plane (in the form: z = A*x + B*y + C).
#'
#' @param x A \code{Planes} object.
#' @param \dots Additional arguments for the S3 method '\code{print}'.
#'
#' @return
...
########################
#'
#' @title Return a summary of a \code{Planes} object
#'
#' @description Returns the below information about the \code{object}:
#'
...
########################
#'
#' @title Print a summary of a \code{Planes} object
#'
#' @description Prints some information about the \code{object}.
#'
#' @param x	 object of class "\code{summary.Planes}", generated by \code{summary.Planes}.
#' @param \dots Additional parameters for \code{print}.
#'
#' @return
#' None
...
########################
#'
#' @title Plot a \code{Planes} object
#'
...
###############################################
#'
#' @title Print a \code{Uniform} object
#'
#' @description Prints the \code{call} of the object of class '\code{Uniform}'
#' and also the \code{type} (i.e. a brief description) of the uniform distribution).
#'
#' @param x A \code{Uniform} object.
#' @param \dots Additional arguments for the S3 method '\code{print}'.
#'
#' @return
#' The \code{call} of the object of class '\code{Uniform}'
#' and also the \code{type} (i.e. a brief description) of the uniform distribution).
#'
...
########################
#'
#' @title Return a summary of a \code{Uniform} object
#'
#' @description Returns the below information about the \code{object}:
#'
...
########################
#'
#' @title Print a summary of a \code{Uniform} object
#'
#' @description Prints some information about the \code{object}.
#'
#' @param x	 object of class "\code{summary.Uniform}", generated by \code{summary.Uniform}.
#' @param \dots Additional parameters for \code{print}.
#'
#' @return
#' None
...
########################
#'
#' @title Plot a \code{Uniform} object
#'
...
###############################################
#'
#' @title Print a \code{Extrema} object
#'
#' @description Prints the \code{call} of the object of class '\code{Extrema}'
#' and also the \code{type} (i.e. a brief description) of the extrema).
#'
#' @param x A \code{Extrema} object.
#' @param \dots Additional arguments for the S3 method '\code{print}'.
#'
#' @return
#' The \code{call} of the object of class '\code{Extrema}'
#' and also the \code{type} (i.e. a brief description) of the extrema).
#'
...
########################
#'
#' @title Return a summary of a \code{Extrema} object
#'
#' @description Returns the below information about the \code{object}:
#'
...
########################
#'
#' @title Print a summary of a \code{Extrema} object
#'
#' @description Prints some information about the \code{object}.
#'
#' @param x	 object of class "\code{summary.Extrema}", generated by \code{summary.Extrema}.
#' @param \dots Additional parameters for \code{print}.
#'
#' @return
#' None
...
########################
#'
#' @title Plot an \code{Extrema} object
#'
...
###############################################
#'
#' @title Print a \code{PCDs} object
#'
#' @description Prints the \code{call} of the object of class '\code{PCDs}'
#' and also the \code{type} (i.e. a brief description) of the proximity catch digraph (PCD)).
#'
#' @param x A \code{PCDs} object.
#' @param \dots Additional arguments for the S3 method '\code{print}'.
#'
#' @return
#' The \code{call} of the object of class '\code{PCDs}'
#' and also the \code{type} (i.e. a brief description) of the proximity catch digraph (PCD)).
#'
...
########################
#'
#' @title Return a summary of a \code{PCDs} object
#'
#' @description Returns the below information about the \code{object}:
#'
...
#'
#' @return
#' The \code{call} of the object of class '\code{PCDs}', the \code{type} of the proximity catch digraph (PCD),
#' (i.e. the description of the PCD), some of the partition (i.e. intervalization in the 1D case and triangulation
#' in the 2D case) points (i.e., vertices of the intervals or the triangles), some of the tails (or source points)
#' and the heads (or end points) of the arcs of the PCD, parameter of the PCD, and various quantitites (number of vertices,
#' number of arcs and arc density of the PCDs, number of vertices for the partition and number of partition cells
...
########################
#'
#' @title Print a summary of a \code{PCDs} object
#'
#' @description Prints some information about the \code{object}.
#'
#' @param x	 object of class "\code{summary.PCDs}", generated by \code{summary.PCDs}.
#' @param \dots Additional parameters for \code{print}.
#'
#' @return
#' None
